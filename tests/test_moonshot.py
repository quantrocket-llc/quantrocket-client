...
EOD_AGGREGATE_RESULTS = {
    'dma-tech': {
        ...
        ('Trade', '2016-03-17'): 0.0,
        ('Trade', '2016-03-18'): 0.0}}
...
INTRADAY_AGGREGATE_RESULTS = {
    'fx-revert': {
        ...
        ('Trade', '2018-12-18', '09:00:00'): 0.1,
        ('Trade', '2018-12-18', '10:00:00'): 0.0,
        ('Trade', '2018-12-18', '11:00:00'): 0.0,
        ('Trade', '2018-12-19', '09:00:00'): 0.1,
        ('Trade', '2018-12-19', '10:00:00'): 0.1,
        ('Trade', '2018-12-19', '11:00:00'): 0.1}
}
...
INTRADAY_DETAILED_RESULTS = {
    ...
    'GBP.USD(12087797)': {
        ...
        ('Trade', '2018-12-18', '10:00:00'): 0.0,
        ('Trade', '2018-12-18', '11:00:00'): 0.0,
        ('Trade', '2018-12-19', '09:00:00'): 0.0,
        ('Trade', '2018-12-19', '10:00:00'): 0.0,
        ('Trade', '2018-12-19', '11:00:00'): 0.0,
        ('Weight', '2018-12-18', '09:00:00'): 0.0,
        ('Weight', '2018-12-18', '10:00:00'): 0.0,
        ('Weight', '2018-12-18', '11:00:00'): 0.0,
...
class IntradayToDailyTestCase(unittest.TestCase):
    """
    Test cases for `quantrocket.moonshot.intraday_to_daily`.
    """
    ...
    def test_aggregate_intraday_to_daily(self):
        ...
        self.assertDictEqual(
            ...
            {'fx-revert': {
                ...
                # sum
                ('Trade', '2018-12-18'): 0.1,
                ('Trade', '2018-12-19'): 0.30000000000000004}}
        )
