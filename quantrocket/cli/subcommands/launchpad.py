...
def add_subparser(subparsers):
    ...
    parser = _subparsers.add_parser("status", help=" query statuses of IB Gateway services")
    ...
    parser.add_argument("-t", "--sec-type", dest="sec_type", choices=["STK", "FUT", "CASH", "OPT"], help="limit to IB Gateway services with market data permission for these securitiy types (useful for disambiguating permissions for exchanges that trade multiple asset classes)")
