...
class GetSecuritiesTestCase(unittest.TestCase):
    ...
    def test_cast_boolean_and_date_fields(self, mock_download_master_file):
        ...
        self.assertListEqual(
            securities.reset_index().sort_values(
                "Sid").fillna('nan').to_dict(orient="records"),
            [{'Sid': 'FIBBG000001PV7',
            'Symbol': 'GOODO',
            'Exchange': 'XNAS',
            'Country': 'US',
            ...
            'sharadar_FirstQuarter': pd.NaT,
            'sharadar_Industry': 'REIT - Diversified',
            'sharadar_LastPriceDate': pd.Timestamp('2019-10-25 00:00:00'),
            'sharadar_LastQuarter': pd.NaT,
            ...
            'edi_PrimaryMic': 'nan',
            'edi_RecordCreated': pd.NaT,
            'edi_RecordModified': pd.NaT,
            'edi_SecId': 'nan',
            'edi_SecTypeCode': 'nan',
            'edi_SecTypeDesc': 'nan',
            ...
            'sharadar_FamaSector': 'nan',
            'sharadar_FirstAdded': pd.NaT,
            'sharadar_FirstPriceDate': pd.NaT,
            'sharadar_FirstQuarter': pd.NaT,
            'sharadar_Industry': 'nan',
            'sharadar_LastPriceDate': pd.NaT,
            'sharadar_LastQuarter': pd.NaT,
            'sharadar_LastUpdated': pd.NaT,
            ...
            'sharadar_Ticker': 'nan',
            'usstock_DateDelisted': pd.NaT,
            'usstock_FirstPriceDate': pd.NaT,
            'usstock_LastPriceDate': pd.NaT,
            'usstock_Mic': 'nan',
            'usstock_Name': 'nan',
